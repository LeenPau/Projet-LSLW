...
"""if __name__ == '__main__':
    ...
    game.terrain = Terrain(cellules, liste_adjacence)
    ...
    if(cells is not None):
        for cell in cells:
            game.terrain.cellules[int(cell[0])].player = cell[1]
            game.terrain.cellules[int(cell[0])].nbUnit_Off = cell[2]
            game.terrain.cellules[int(cell[0])].nbUnit_Def = cell[3]
