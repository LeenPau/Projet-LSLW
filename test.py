    ...
    #Initialisation
        ...
        if infos is not None:
            ...
            for i in second:
                ...
                tmp['cellid'] = cell.group(4)#cellid
                tmp['owner'] = cell.group(4)#owner
                tmp['offunits'] = cell.group(4)#offunits
                tmp['defunits'] = cell.group(4)#defunits
            ...
            for element in inter:
                ...
                if move is not None:
                    for i in move:
                        ...
                        if meta is not None:
                            if(meta.group(1) == "<"):
                                toAdd['source'] = cellule_fin
                                toAdd['destinatation'] = cellule_debut
                                toAdd['nbUnits'] = meta.group(2)
                                toAdd['owner'] = meta.group(3)
                                toAdd['timestamp'] = meta.group(4)
                            else:
                                toAdd['source'] = cellule_fin
                                toAdd['destinatation'] = cellule_debut
                                toAdd['nbUnits'] = meta.group(2)
...
if __name__ == '__main__':
    #state_string = "STATE20ac18ab-6d18-450e-94af-bee53fdc8fcaIS2;3CELLS:1[2]12'4,2[2]15'2,3[1]33'6;4MOVES:1<5[2]@232'>6[2]@488'>3[1]@4330'2,1<10[1]@2241'3"
    #print(decodage_state(state_string))
    ...
    print(decodage_init(init_string))
